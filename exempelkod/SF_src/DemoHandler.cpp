...
void DemoHandler::drawPolygon(const std::vector<Point>& pts,Color c)
{
	...
	p1.mX-= p0.mX;p1.mY-= p0.mY;p1.mZ-= p0.mZ;
	p2.mX-= p0.mX;p2.mY-= p0.mY;p2.mZ-= p0.mZ;

	Point n = Point(p1.mY*p2.mZ-p1.mZ*p2.mY,p1.mZ*p2.mX-p1.mX*p2.mZ,p1.mX*p2.mY-p1.mY*p2.mX);
	setColor(c);
	glBegin(GL_POLYGON);	
